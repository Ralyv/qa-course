...
The edited page must appears at QA site page
	...
	Scenario: Successfully edit page name 
		Given I have chosen a page to edit in admin panel
	    When  I change a page name
		And   I press "Update" button
		Then  The changed page name should appear at "QA site" page
		
	Scenario: Successfully edit a page contents
		Given I have chosen a page to edit in admin panel
	    When  I change a page contents
		And   I press "Update" button
		Then  The changed page contents should appear at "QA site" page
